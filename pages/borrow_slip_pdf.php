...
<table border="1" cellpadding="5">
    ...
    <tr><td><b>Lender</b></td><td>' . h(trim((string) ($summary['lender'] ?? '')) !== '' ? (string) $summary['lender'] : '-') . '</td></tr>
    ...
    <tr><td><b>Returned By</b></td><td>' . h(trim((string) ($summary['returned_by'] ?? '')) !== '' ? (string) $summary['returned_by'] : '-') . '</td></tr>
